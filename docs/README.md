...
| 5 | Adjudication of deviations (Zulip/JIRA/WGM); spec RFCs | **in progress** (2026-09-02: [WGM question brief](wgm-brief-2026-09.md) drafted — 16 questions in three tiers, self-contained, freeze target 2026-09-14; Zulip `all`-stream + JIRA sweeps per question run the same day, results folded into the brief's Appendix B and into ch14 statuses; RFC-015 written up from the spec/extension-pack evidence. 2026-09-03: brief **v2** — executive summary added, evidence tiers (resolution vs comment vs Zulip agreement) marked throughout after REST spot-checks of 16 tickets, coherence fixes, "after the session" routing; same day **v3 = FROZEN** after a read-through of the summary against Q1–Q16 — only Ewout-requested corrections until the WGM. Pre-WGM carry-ins closed 2026-09-03: DEV-029 default-settings re-run (throws are settings-independent), DEV-033 minimized repro (attached to org.hl7.fhir.core#2584), JI-14/18/19 verified and filed as #2603/#2602/#2604, new JI-21 filed as #2605; DEV-031 pinned empirically and filed as firely-net-sdk#3597; ch1 overview refreshed with the .NET/Java architecture summaries and a reading guide) |
